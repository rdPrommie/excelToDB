...
public class startAblak extends javax.swing.JFrame {
    ...
    public startAblak() {          
        setTitle("Deep Purple - Vizsgamegoldás");
    ...
    JLabel jLabel1  = new JLabel("ExcelToDatabase");jPanel.add(jLabel1); Font font = new Font("Times New Roman", Font.BOLD + Font.ITALIC,20); jLabel1.setFont(font);
    JPanel jPane2   = new JPanel(); cp.add(jPane2); 
    JPanel jPane3   = new JPanel();cp.add(jPane3);//jPane3.setLayout(new BoxLayout(cp, 3));
    ...
    JButton button  = new JButton("Táblázat beolvasás");//SQL-megjelenítés
    JButton button2 = new JButton("Készítette");//SQL-parancsok
    JButton button3 = new JButton("Kilépés");//Kilépés
    ...
    class GombFigyelo implements java.awt.event.ActionListener{
            public void actionPerformed(java.awt.event.ActionEvent e){
                if(e.getSource() == button3) System.exit(0);
                    ...
                    dispose(); System.out.println("Dispose: startAblak.");
                }
